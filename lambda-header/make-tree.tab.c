...
{
       0,    50,    50,    51,    55,    56,    61,    65,    66,    67,
      70,    71,    79,    86,    96,   101,   112,   113,   121,   129,
     137,   145,   153,   161,   169,   178,   179
};
#endif
...
{
      -5,    43,    -5,    -4,    -5,    -5,    61,     6,    -5,    -3,
      11,    66,    69,    -5,    72,    48,    51,    -5,     4,    -5,
      11,    -5,    66,    -5,    -5,    61,    -5,    -5,    61,    -5,
      -5,    -5,    61,     5,     9,    75,    58,    11,    66,    69,
      11,    66,    69,    -5,    -5
};
...
static const yytype_int8 yydefact[] =
{
       ...
       7,     8,     9,     6,     0,     0,     0,    14,     0,     5,
       0,    18,     0,    19,    23,     0,    22,    17,    10,    16,
      26,    15,     0,     0,     0,     0,     0,     0,    20,    24,
      11,    12,    13,    10,    21
};
...
{
      10,    12,    13,    19,    15,    14,    16,    31,    32,    17,
      23,    26,    27,    43,    23,    26,    27,    30,    20,    33,
       7,    33,    34,    36,    35,    16,    38,    37,    39,     0,
      41,    40,    42,     0,     0,    23,     0,    23,    26,    27,
      23,    26,    27,     2,     3,     0,     4,     0,     0,     5,
       6,     4,     7,     0,     4,    22,    29,     7,    25,    30,
       7,     4,     0,     0,     4,    22,    44,     7,     6,     4,
       7,     0,     4,    22,     0,     7,    25,     0,     7,    20,
      28,     7,    20,    43,     7
};
...
{
       1,     1,     6,     6,     6,     6,     6,     3,     4,     3,
      11,    12,    12,     8,    15,    16,    16,     8,     7,    20,
       9,    22,    22,    25,    25,    25,    28,    28,    28,    -1,
      32,    32,    32,    -1,    -1,    36,    -1,    38,    39,    39,
      41,    42,    42,     0,     1,    -1,     3,    -1,    -1,     6,
       7,     3,     9,    -1,     3,     7,     8,     9,     7,     8,
       9,     3,    -1,    -1,     3,     7,     8,     9,     7,     3,
       9,    -1,     3,     7,    -1,     9,     7,    -1,     9,     7,
       8,     9,     7,     8,     9
...
static const yytype_int8 yystos[] =
{
      ...
      14,    16,    17,     6,    14,    16,    17,     3,    15,     6,
       7,    14,     7,    14,    17,     7,    14,    17,     8,     8,
       8,     3,     4,    14,    17,    14,    16,    14,    16,    17,
      14,    16,    17,     8,     8
};
...
#line 61 "make-tree.y"
             { yyerrok;
  fclose(file); }
#line 1427 "make-tree.tab.c"
    break;

  case 10: /* abst: '(' abst ')'  */
#line 70 "make-tree.y"
                   {(yyval.abst) = (yyvsp[-1].abst);}
#line 1433 "make-tree.tab.c"
    break;
...
#line 1466 "make-tree.tab.c"
    break;

  case 14: /* abstvars: VAR  */
#line 96 "make-tree.y"
              {
  node *n = make_node('.');
...
#line 1476 "make-tree.tab.c"
    break;

  case 15: /* abstvars: abstvars VAR  */
#line 102 "make-tree.y"
{
  node *i;
  node *ab = make_node('.');
...
#line 1489 "make-tree.tab.c"
    break;

  case 16: /* appl: '(' appl ')'  */
#line 112 "make-tree.y"
                   {(yyval.appl) = (yyvsp[-1].appl);}
#line 1495 "make-tree.tab.c"
    break;

  case 17: /* appl: vars vars  */
#line 114 "make-tree.y"
{
  node *n = make_node('&');
...
#line 1506 "make-tree.tab.c"
    break;

  case 18: /* appl: abst abst  */
#line 122 "make-tree.y"
{
  node *n = make_node('&');
...
#line 1517 "make-tree.tab.c"
    break;

  case 19: /* appl: appl abst  */
#line 130 "make-tree.y"
{
  node *n = make_node('&');
...
#line 1528 "make-tree.tab.c"
    break;

  case 20: /* appl: '(' abst ')' appl  */
#line 138 "make-tree.y"
{
  node *n = make_node('&');
...
#line 1539 "make-tree.tab.c"
    break;

  case 21: /* appl: vars '(' appl ')'  */
#line 146 "make-tree.y"
{
  node *n = make_node('&');
...
#line 1550 "make-tree.tab.c"
    break;

  case 22: /* appl: vars abst  */
#line 154 "make-tree.y"
{
  node *n = make_node('&');
  add_child(n,(yyvsp[-1].vars),'l');
  add_child(n,(yyvsp[0].abst),'r');
...
#line 1561 "make-tree.tab.c"
    break;

  case 23: /* appl: appl vars  */
#line 162 "make-tree.y"
{
  node *n = make_node('&');
  add_child(n,(yyvsp[-1].appl),'l');
  add_child(n,(yyvsp[0].vars),'r');
...
#line 1583 "make-tree.tab.c"
    break;

  case 25: /* vars: VAR  */
#line 178 "make-tree.y"
           {(yyval.vars) = make_node((yyvsp[0].VAR));}
#line 1589 "make-tree.tab.c"
    break;

  case 26: /* vars: '(' vars ')'  */
#line 179 "make-tree.y"
               {(yyval.vars) = (yyvsp[-1].vars);}
#line 1595 "make-tree.tab.c"
    break;


#line 1599 "make-tree.tab.c"
